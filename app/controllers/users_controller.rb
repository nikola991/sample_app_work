class UsersController < ApplicationController
  ...
  before_action :correct_user, only: [:edit, :update]    #za da moze da gi koristi tie funkcionalnosti prvo mora da e logiran, vtoro mora da e correct user
  ...
  def edit
    #od before action ima instance @user zemeno
  end
  def index
